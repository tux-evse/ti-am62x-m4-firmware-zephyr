...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_TI_OMAP_MAILBOX_ENABLED, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BOARD_PHYBOARD_LYRA, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BOARD_PHYBOARD_LYRA_AM6234_M4, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SOC_SERIES_AM6X_M4, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SOC_AM6234_M4, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_IPM_LOG_LEVEL, 4);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MBOX, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MBOX_TI_OMAP_MAILBOX, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MBOX_INIT_PRIORITY, 40);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MBOX_LOG_LEVEL_DBG, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MBOX_LOG_LEVEL, 4);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MM_DRV, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MM_DRV_PAGE_SIZE, 0x1000);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_EXTERNAL_ADDRESS_TRANSLATION, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MM_TI_RAT, 1);
